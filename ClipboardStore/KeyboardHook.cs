...
namespace WIndowsFormStudy
{
    public class KeyboardHook : IDisposable
    {
        ...
        private LowLevelKeyboardProc proc_;
        ...
        public KeyboardHook()
        {
            ...
            proc_ = HookProc;
            hook = SetWindowsHookEx(WH_KEYBOARD_LL, proc_, hInstance, 0);
        }
        ~KeyboardHook()
        {
            Dispose();
        ...
        private IntPtr HookProc(int code, IntPtr wParam, IntPtr lParam)
        {
            ...
            if(curKey == VKeys.VK_F9 && IsKeyPress(VKeys.VK_F9, KeyPressedStatus.PressedNow))
            {
                KeyPressed();
                return (IntPtr)1;
            }
